...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 1', 'madinah 2') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 1', 'madinah 2')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 1 & 2</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 1 & 2</h1>
