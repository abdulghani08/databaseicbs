...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class=" py-2">
        <h1 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Rekapan Ujian Kepesantrenan</h1>
        <div class="add-santri-button text-center">
            <a class="btn btn-kuning" href="form_tambahujian_kepesantrenan.php?nis= <?php echo $nis; ?>&nama=<?php echo $nama; ?> ">Tambah Ujian</a>
        </div>
    </div>
