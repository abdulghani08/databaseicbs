...
$query = "SELECT * FROM portopolio_isi WHERE nis LIKE '%$search%' OR nama LIKE '%$search%' OR asrama LIKE '%$search%' OR kelas LIKE '%$search%' ORDER BY $sortColumn $sortOrder LIMIT $limit OFFSET $offset";
...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h1 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Kepesantrenan Santri</h1>
        <div class="add-santri-button text-center">
            <a class="btn btn-kuning" href="form_tambahdata_santri_portopolio.php">Tambah Data Santri</a>
            <a class="btn btn-kuning" href="hapus_datasantri_portopolio.php">Hapus Data Santri</a>
        </div>
    </div>

    <div class="container">
        <div class="card py-2 mb-6" style="overflow-x: auto;">
            <div class="card-form shadow p-4 bg-body-tertiary rounded">
                <div class="container mt-2 table-responsive">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-8">
                                <div class="input-group input-group-outline">
                                    <input type="text" name="search" class="form-control" placeholder="Cari Santri" value="<?php echo htmlspecialchars($kataPencarian); ?>" />
                                </div>
                            </div>
                            <!-- Kolom tombol -->
                    ...
                    <div class="add-button">
                        <a class="fw-bold" style="font-size: 13px;" href="dt_portopolio.php">Lihat Seluruh Table</a>
                    </div>
                </div>
            </div>
            <section>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td class="action-links text-center">
                                        <a class="update" style="margin-right: 20%;" href="update_portopolio.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                                                <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/>
                                            </svg>
                                        </a>
                                        <a class="edit" href="edit_datasantri_portopolio.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>">
