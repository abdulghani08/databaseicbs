...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('kairo 1', 'kairo 2') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('kairo 1', 'kairo 2')
...
<head>
    ...
    <title>Laporan BW - Asrama Kairo 1 & 2</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Kairo 1 & 2</h1>
