...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 15', 'madinah 16') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 15', 'madinah 16')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 15 & 16</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 15 & 16</h1>
