...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('multazam 1', 'multazam 2') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('multazam 1', 'multazam 2')
...
<head>
    ...
    <title>Laporan BW - Asrama Multazam 1 & 2</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Multazam 1 & 2</h1>
