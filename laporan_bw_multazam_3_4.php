...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('multazam 3', 'multazam 4') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('multazam 3', 'multazam 4')
...
<head>
    ...
    <title>Laporan BW - Asrama Multazam 3 & 4</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Multazam 3 & 4</h1>
