...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('multazam 7', 'multazam 8') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('multazam 7', 'multazam 8')
...
<head>
    ...
    <title>Laporan BW - Asrama Multazam 7 & 8</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Multazam 7 & 8</h1>
