...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 13', 'madinah 14') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 13', 'madinah 14')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 13 & 14</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 13 & 14</h1>
