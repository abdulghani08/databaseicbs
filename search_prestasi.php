...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h1 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Data Prestasi Santri</h1>
    </div>
            ...
            <div class="card-form shadow p-4 bg-body-tertiary rounded">
                <div class="container mt-2 table-responsive">
                    ...
                    <div class="add-button">
                        <a class="fw-bold" style="font-size: 13px;" href="dt_prestasi.php">Lihat Seluruh Table</a>
                    </div>
                </div>
            </div>
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td class="action-links text-center">
                                    <a class="update" href="update_prestasi.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"target="_blank">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-info-circle-fill" viewBox="0 0 16 16">
                                            <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m.93-9.412-1 4.705c-.07.34.029.533.304.533.194 0 .487-.07.686-.246l-.088.416c-.287.346-.92.598-1.465.598-.703 0-1.002-.422-.808-1.319l.738-3.468c.064-.293.006-.399-.287-.47l-.451-.081.082-.381 2.29-.287zM8 5.5a1 1 0 1 1 0-2 1 1 0 0 1 0 2"/>
                                        </svg>
                                    </a>
                                    <!-- <a class="edit" href="edit_datasantri_prestasi.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"><img src="edit_icon.png" alt="Edit"></a>
                                    <a class="delete" href="hapus_datasantri_prestasi.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"><img src="delete_icon.png" alt="Delete"></a> -->
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
