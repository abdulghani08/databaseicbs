...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO perizinan_isi (id, nis, nama, asrama, kelas, daritanggal, sampaitanggal, keperluan, durasi) VALUES ('$next_id', '$nis', '$nama', '$asrama', '$kelas', '$daritanggal', '$sampaitanggal', '$keperluan', '$durasi')";
    $result = mysqli_query($koneksi, $query);
...
>>>>>>> a74c40d8e2cfd4f937b47d5c5f55958d68767b2c
    ...
    <div class="container py-2">
        <h2 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Form Tambah Perizinan Santri</h2>
    </div>
    ...
    <div class="container mb-6">
        ...
        <a class="fw-bold py-2" style="font-size: 13px;" href="dt_perizinan.php">Kembali ke Data Santri</a>
                        ...
                        <form method="POST">
                            ...
                            <div class="row">
                                <div class="form-group col-12 col-md-6">
                                    ...
                                    <input class="form-control2" type="date" id="daritanggal" name="daritanggal" required>
                                </div>

                                <div class="form-group col-12 col-md-6">
                                    <label for="sampaitanggal">Sampai Tanggal :</label>
                                    <input class="form-control2" type="date" id="sampaitanggal" name="sampaitanggal" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="form-group col-12 col-md-6">
                                    <label for="keperluan">Keperluan Izin :</label>
                                    <input class="form-control2" type="text" id="keperluan" name="keperluan" required>
                                </div>
                            
                                <div class="form-group col-12 col-md-6">
                                    <label for="durasi">Durasi Izin (Hari) :</label>
                                    <input class="form-control2" type="number" id="durasi" name="durasi" min="1" required>
                                </div>
                            </div>
                            <div class="col-md-12">
                                    <button type="submit" class="btn bg-gradient-info w-100"  value="Tambah ">Tambah</button>
                                </div>
                        </form>
                        </div>
                    </div>
