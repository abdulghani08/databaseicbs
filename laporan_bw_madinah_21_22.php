...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 21', 'madinah 22') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 21', 'madinah 22')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 21 & 22</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 21 & 22</h1>
