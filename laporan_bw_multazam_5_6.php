...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('multazam 5', 'multazam 6') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('multazam 5', 'multazam 6')
...
<head>
    ...
    <title>Laporan BW - Asrama Multazam 5 & 6</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Multazam 5 & 6</h1>
