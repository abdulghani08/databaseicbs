...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('riyadh 2', 'riyadh 3') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('riyadh 2', 'riyadh 3')
...
<head>
    ...
    <title>Laporan BW - Asrama Riyadh 2 & 3</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Riyadh 2 & 3</h1>
