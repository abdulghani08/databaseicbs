...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h1 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Data Tahfizh</h1>
    </div>
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <a class="update" href="update_tahfizh.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>" target="_blank">
