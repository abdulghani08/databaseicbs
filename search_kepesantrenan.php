...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        ...
        <div class="add-santri-button text-center">
            <a class="btn btn-kuning" href="dt_ujiankepesantrenan.php">Lihat Daftar Ujian Kepesantrenan</a>
        </div>
    </div>
            ...
            <div class="card-form shadow p-4 bg-body-tertiary rounded">
                <div class="container mt-2 table-responsive">
                    ...
                    <div class="add-button">
                        <a class="fw-bold" style="font-size: 13px;" href="dt_kepesantrenan.php">Lihat Seluruh Table</a>
                    </div>
                </div>
            </div>
            <section>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td class="action-links text-center">
                                        <a class="update" href="update_kepesantrenan.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"target="_blank">
