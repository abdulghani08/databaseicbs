...
$query = "SELECT * FROM disiplin_isi WHERE nis = '$nis' AND nama = '$nama'";
...
if (isset($_POST['update'])) {
    ...
    $update_query = "UPDATE disiplin_isi SET tanggal='$tanggal', pelanggaran='$pelanggaran', poin='$poin', hukuman='$hukuman', keterangan='$keterangan' WHERE nis='$nis' AND nama='$nama'";
