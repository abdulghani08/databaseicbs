...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 3', 'madinah 4') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 3', 'madinah 4')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 3 & 4</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 3 & 4</h1>
