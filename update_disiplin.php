...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class=" py-2">
        <h2 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">REKAPAN KEDISIPLINAN</h2>
        <div class="add-santri-button text-center">
                    <a class="btn btn-kuning" href="form_tambahdata_disiplin.php?nis=<?php echo $nis; ?>&nama=<?php echo $nama; ?>">Tambah Pelanggaran</a>
                </div>
    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            while ($setoran_data = mysqli_fetch_array($setoran_result)) {
                                ...
                                <a class="edit" href="edit_kedisiplinan.php?id=<?php echo $setoran_data['id']; ?>">
