        ...
        <div class="card py-2 mb-6" style="overflow-x: auto;">
            <div class="card-form shadow p-4 bg-body-tertiary rounded">
                <div class="container mt-2 table-responsive">
                    ...
                    <form method="GET" action="search_perizinan.php">
                        <div class="row">
                            <!-- Kolom pencarian -->
                    ...
                    <div class="add-button">
                        <a class="fw-bold" style="font-size: 13px;" href="dt_perizinan.php">Lihat Seluruh Table</a>
                    </div>
                </div>
            </div>
            <section>
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center">Total Perizinan</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="action-links text-center">
                                        <a class="update" href="update_perizinan.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>">
