...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 7', 'madinah 8') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 7', 'madinah 8')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 7 & 8</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 7 & 8</h1>
