...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('iskandariyah 4', 'iskandariyah 5') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('iskandariyah 4', 'iskandariyah 5')
...
<head>
    ...
    <title>Laporan BW - Asrama Iskandariyah 4 & 5</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Iskandariyah 4 & 5</h1>
