...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 23', 'madinah 24', 'madina 23', 'madina 24') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 23', 'madinah 24', 'madina 23', 'madina 24')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 23 & 24</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 23 & 24</h1>
