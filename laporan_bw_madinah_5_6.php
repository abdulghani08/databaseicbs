...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 5', 'madinah 6') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 5', 'madinah 6')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 5 & 6</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 5 & 6</h1>
