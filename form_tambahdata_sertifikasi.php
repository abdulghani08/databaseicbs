...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h2 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Form Tambah Pengalaman Kegiatan Tersertifikasi</h2>
    </div>
                        ...
                        <div class=" justify-space-between table-responsive">
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <label class="col-form-label2" for="nama_kegiatan">Nama Kegiatan</label>
                                    <input class="input-group2" type="text" id="nama_kegiatan" name="nama_kegiatan" required>
                                    </div>

                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="waktu_kegiatan">Waktu Pelaksaaan Kegiatan</label>
                                    <input class="input-group2" type="date" id="waktu_kegiatan" name="waktu_kegiatan"required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
