                        ...
                        <form method="POST">
                            <div class="row">
                                ...
                                <div class="form-group col-12 col-md-6">
                                    <label for="tanggal" class="col-form-label2">Tanggal</label>
                                    <div class="input-group2 mb-3">
                                        <input type="date" class="form-control2" id="tanggal" name="tanggal" >
                                    </div>
                                </div>
                                
                                <!-- Kolom kedua -->
                                <div class="form-group col-12 col-md-6">
                                    <label for="jenis" class="col-form-label2">Jenis Ujian</label>
                                    <div class="input-group2 mb-3">
                                        <select class="input-group2" class="input-group2" id="jenis" name="jenis" required>
                            ...
                            <div class="row">
                                <!-- Kolom pertama -->
                                <div class="form-group col-12 col-md-6">
                                    <label for="nilai" class="col-form-label2">Tanggal</label>
                                    <div class="input-group2 mb-3">
                                        <select class="input-group2" id="nilai" name="nilai" required>
                                ...
                                <!-- Kolom kedua -->
                                <div class="form-group col-12 col-md-6">
                                    <label for="penguji" class="col-form-label2">Nama Penguji</label>
                                    <div class="input-group2 mb-3">
                                        <input type="penguji" class="form-control2" id="penguji" name="penguji" >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <!-- Kolom pertama -->
                                <div class="form-group col-12 col-md-6">
                                    <label for="keterangan" class="col-form-label2">Keterangan</label>
                                    <div class="input-group2 mb-3">
                                        <select class="input-group2" id="keterangan" name="keterangan" required>
                                ...
                                <!-- Kolom kedua -->
                                <div class="form-group col-12 col-md-6">
                                    <label for="catatan" class="col-form-label2">Catatan</label>
                                    <div class="input-group2 mb-3">
                                        <input type="catatan" class="form-control2" id="catatan" name="catatan" >
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-12">
                                    <button type="submit" class="btn bg-gradient-info w-100"  value="Tambah Ujian">Register</button>
                                </div>
                        </form>
                        </div>
                    </div>
