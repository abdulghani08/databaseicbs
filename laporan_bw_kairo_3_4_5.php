...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('kairo 3', 'kairo 4', 'kairo 5') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('kairo 3', 'kairo 4', 'kairo 5')
...
<head>
    ...
    <title>Laporan BW - Asrama Kairo 3,4, & 5</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Kairo 3,4, & 5</h1>
