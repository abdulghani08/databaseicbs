            ...
            <div class="card-form shadow p-4 bg-body-tertiary rounded">
                <div class="container mt-2 table-responsive">
                    ...
                    <div class="add-button">
                        <a class="fw-bold" style="font-size: 13px;" href="dt_disiplin.php">Lihat Seluruh Table</a>
                    </div>
                </div>
            </div>
                            ...
                            <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                                <tr>
                                    ...
                                    <td class="action-links text-center">
                                        <a class="update" href="update_disiplin.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"target="_blank">
