...
<body>
    <div class="container">
        <div>
            <a href="dt_disiplin.php"><img src="back_icon.png" alt="back" style="width: 30px; height: auto;"></a>
        </div>
        <h2>REKAPAN KEDISIPLINAN</h2>
        
        <div class="action-buttons">
            <a href="form_tambahdata_disiplin.php?nis=<?php echo $nis; ?>&nama=<?php echo $nama; ?>" class="action-button">
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th class="hide-mobile">Klasifikasi</th>
                        <th class="hide-mobile">Bentuk Hukuman</th>
                        <th class="hide-mobile">Hukuman Tambahan</th>
                ...
                <tbody>
                    ...
                    while ($setoran_data = mysqli_fetch_array($setoran_result)) {
                        ...
                        <tr>
                            ...
                            <td class="hide-mobile"><?php echo $setoran_data['klasifikasi']; ?></td>
                            <td class="hide-mobile"><?php echo $setoran_data['hukuman']; ?></td>
                            <td class="hide-mobile"><?php echo $setoran_data['hukumantambahan']; ?></td>
                            <td class="hide-mobile"><?php echo $setoran_data['keterangan']; ?></td>
                            <td class="action-links">
                                <a class="edit" href="edit_kedisiplinan.php?id=<?php echo $setoran_data['id']; ?>"><img src="edit_icon.png" alt="Edit"></a>
    ...
    <script>
        ...
        document.querySelectorAll('table, .details, .total-hafalan').forEach(el => {
            observer.observe(el);
        });
    </script>
</body>
