...
$query = "SELECT * FROM putra_portopolio_isi ORDER BY $sortColumn $sortOrder";
$result = mysqli_query($koneksi, $query);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Data Santri Prestasi</title>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td class="action-links">
                            <a class="update" href="update_prestasi.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"><img src="../update_icon.png" alt="Update"></a>
