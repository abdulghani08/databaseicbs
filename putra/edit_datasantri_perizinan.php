...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE putra_perizinan_data SET nama='$nama', kelas='$kelas', asrama='$asrama', pembina='$pembina' WHERE nis='$nis'";
...
$nis = $_GET['nis'];
$query = "SELECT * FROM putra_perizinan_data WHERE nis='$nis'";
$result = mysqli_query($koneksi, $query);
...
<html>
<head>
    <title>Edit Data Santri Perizinan</title>
...
<body>
    ...
    <div class="button">
        ...
        <h2>Edit Data Santri Perizinan</h2>
