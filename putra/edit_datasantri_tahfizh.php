...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE putra_tahfizh_data SET nama='$nama', kelas='$kelas', asrama='$asrama', pembina='$pembina', muhafizh='$muhafizh' WHERE nis='$nis'";
...
$nis = $_GET['nis'];
$query = "SELECT * FROM putra_tahfizh_data WHERE nis='$nis'";
$result = mysqli_query($koneksi, $query);
...
<html>
<head>
    <title>Edit Data Santri Tahfizh</title>
...
<body>
    <div class="container">
        ...
        <h2>Edit Data Santri Tahfizh</h2>
