...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus'])) {
    ...
    $query = "DELETE FROM putra_disiplin_data WHERE nis='$nis'";
...
$query = "SELECT * FROM putra_disiplin_data";
$result = mysqli_query($koneksi, $query);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Data Kedisiplinan</title>
...
<body>
    <center>Hapus Data Santri Kedisiplinan?    
