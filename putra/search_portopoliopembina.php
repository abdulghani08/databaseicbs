...
<body>
    <div class="container">
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['asrama']; ?></td>
                         <td class="action-links">
                            <a class="update" href="update_portopoliopembina.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>"><img src="update_icon.png" alt="Update"></a>
        ...
        <div class="add-button">
            <a href="dt_portopoliopembina.php">Kembali</a>
        </div>
    </div>
</body>
</html>
