...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE putra_disiplin_data SET nama='$nama', kelas='$kelas', asrama='$asrama', pembina='$pembina' WHERE nis='$nis'";
...
$nis = $_GET['nis'];
$query = "SELECT * FROM putra_disiplin_data WHERE nis='$nis'";
$result = mysqli_query($koneksi, $query);
...
<html>
<head>
    <title>Edit Data Santri Kedisiplinan</title>
...
<body>
    ...
    <div class="button">
        ...
        <h2>Edit Data Santri Kedisiplinan</h2>
