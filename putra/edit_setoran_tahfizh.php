...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM putra_tahfizh_hafalan WHERE id='$id_setoran'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $query_update = "UPDATE putra_tahfizh_hafalan SET tanggal='$tanggal', hafalan='$hafalan', nilai='$nilai', total_hafalan='$totalHafalan' WHERE id='$id_setoran'";
