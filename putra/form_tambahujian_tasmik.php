...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO putra_tasmik_isi (nis, nama, asrama, kelas, tanggal, ujian, nilai, total_halaman) VALUES ('$nis', '$nama', '$asrama', '$kelas', '$tanggal', '$ujian', '$nilai', '$total_halaman')";
