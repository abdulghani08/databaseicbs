...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO putra_perizinan_isi (id, nis, nama, daritanggal, sampaitanggal, keperluan, durasi) VALUES ('$next_id', '$nis', '$nama', '$daritanggal', '$sampaitanggal', '$keperluan', '$durasi')";
    $result = mysqli_query($koneksi, $query);
