...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO putra_pengalaman_organisasi_isi (nis, nama, nama_organisasi, jabatan, periode, tingkat) VALUES ('$nis', '$nama', '$nama_organisasi', '$jabatan', '$periode', '$tingkat')";
