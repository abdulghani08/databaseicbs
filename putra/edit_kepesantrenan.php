...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM putra_kepesantrenan_isi WHERE id='$id_kepesantrenan'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $query_update = "UPDATE putra_kepesantrenan_isi SET tanggal='$tanggal', jenis='$jenis', nilai='$nilai', penguji='$penguji', keterangan='$keterangan' WHERE id='$id_kepesantrenan'";
