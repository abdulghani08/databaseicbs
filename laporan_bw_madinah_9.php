...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 9') ORDER BY tanggal DESC, asrama ASC";
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 9</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 9</h1>
