...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('istanbul', 'istanbul 1', 'istanbul 2', 'istanbul 3', 'istanbul 4', 'istanbul 5', 'istanbul 6') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('istanbul', 'istanbul 1', 'istanbul 2', 'istanbul 3', 'istanbul 4', 'istanbul 5', 'istanbul 6')
...
<head>
    ...
    <title>Laporan BW - Asrama Istanbul</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Istanbul</h1>
