...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 17', 'madinah 18') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 17', 'madinah 18')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 17 & 18</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 17 & 18</h1>
