...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h2 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Form Data Minat Bakat</h2>
    </div>
                        ...
                        <div class=" justify-space-between table-responsive">
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <label class="col-form-label2" for="nis">NIS:</label>
                                    <input class="input-group2" type="text" id="nis" name="nis" value="<?php echo $nis; ?>" required readonly>
                                    </div>

                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="nama">Nama:</label>
                                    <input class="input-group2" type="text" id="nama" name="nama" value="<?php echo $nama; ?>" required readonly>
                                    </div>
                                </div>

                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="bakat">Bakat:</label>
                                    <select class="input-group2" id="bakat" name="bakat" required>
                                    ...
                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="jenis">Jenis:</label>
                                    <input class="input-group2" type="text" id="jenis" name="jenis" value="" required readonly>
                                    </div>
                                </div>
                                <div class="col-md-12">
