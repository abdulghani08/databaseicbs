...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('maroko') ORDER BY tanggal DESC, asrama ASC";
...
<head>
    ...
    <title>Laporan BW - Asrama Maroko</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Maroko</h1>
