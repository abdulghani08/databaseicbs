...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <div class="card mb-2">
            <h4 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Grafik Rata-Rata Kualitas Hafalan Santri</h4>
            <div>
        ...
        <div class="card">
            <h4 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Grafik Peringkat Santri 10 Teratas dengan Hafalan Terbanyak</h4>
            <div>
