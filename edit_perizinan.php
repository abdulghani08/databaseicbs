...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM perizinan_isi WHERE id='$id_perizinan'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $query_update = "UPDATE perizinan_isi SET daritanggal='$dari_tanggal', sampaitanggal='$sampai_tanggal', keperluan='$keperluan', durasi='$durasi' WHERE id='$id_perizinan'";
