...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('riyadh 4', 'riyadh 5', 'riyad 4', 'riyad 5') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('riyadh 4', 'riyadh 5', 'riyad 4', 'riyad 5')
...
<head>
    ...
    <title>Laporan BW - Asrama Riyadh 4 & 5</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Riyadh 4 & 5</h1>
