		...
		<div class="wrapper">
			...
			<nav id="sidebar">
			    ...
			    <ul class="list-unstyled">
			      <li>
			        <p>Hak Cipta 2023 &copy; Oleh Abdul Ghani.</p>
			      </li>
			    </ul>
			</nav>
			    ...
			    <nav class="navbar navbar-expand-lg navbar-light bg-light">
			      <div class="container-fluid">
			        <button type="button" id="sidebarCollapse" class="btn btn-info">
			          <i class="fas fa-align-left"></i> | Buatan <a href='https://instagram.com/abdulghani08' title='StokCoding.com' target='_blank'>Abdul Ghani</a>
