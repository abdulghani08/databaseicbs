...
<div class="container">
	<div class="row justify-content-center my-2">
		<div class="col-lg-5 mx-5 border border-success rounded bg-info text-white p-5">
			<h1 class="text-center">AUFA Laundry</h1>
			<h2>Masuk</h2>
			<form method="post">
			...
			<br><center><p style="color: white;">Buatan <a href='https://instagram.com/abdulghani08/' title='StokCoding.com' target='_blank'>Abdul Ghani</a></p></center>
