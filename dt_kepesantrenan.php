...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container">
        <div class="table-responsive">
            <ul class="pagination pagination-sm pagination-info m-4 justify-content-end flex-nowrap">
                <!-- Link untuk Previous -->
                <?php if ($page > 1) { ?>
                    <li class="page-item">
                        ...
                        <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                            <tr>
                                ...
                                <td class="action-links text-center">
                                    <a class="update" href="update_kepesantrenan.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>">
