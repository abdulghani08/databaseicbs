...
$query = "SELECT * FROM portopolio_santri_lulus_smp ORDER BY $sortColumn $sortOrder";
$result = mysqli_query($koneksi, $query);
?>
<!DOCTYPE html>
<html>
<head>
    <title>Portopolio Santri Lulus SMP </title>
...
<body>
    <div class="container">
    <div>
    <a href="dt_ex_santri.php"><img src="back_icon.png" alt="home" style="width: 30px;"></a>
</div>
        <h1>Portopolio Santri Lulus SMP</h1>
