...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO prestasi_data (nis, nama, kelas, asrama, pembina) VALUES ('$nis', '$nama', '$kelas', '$asrama', '$pembina')";
...
<head>
    <title>Form Tambah Data Santri Prestasi</title>
...
<body>
    <div class="container">
        <h2>Form Tambah Data Santri Prestasi</h2>
