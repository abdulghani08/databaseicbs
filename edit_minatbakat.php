...
if (isset($_GET['id'])) {
    ...
    $query = "SELECT * FROM minat_bakat_isi WHERE id='$id_minatbakat'";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $query_update = "UPDATE minat_bakat_isi SET bakat='$nama_peminatan', jenis='$jenis_peminatan' WHERE id='$id_minatbakat'";
