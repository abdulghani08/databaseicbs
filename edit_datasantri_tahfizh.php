...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "UPDATE tahfizh_data SET nama='$nama', kelas='$kelas', asrama='$asrama', pembina='$pembina', muhafizh='$muhafizh' WHERE nis='$nis'";
...
$nis = $_GET['nis'];
$query = "SELECT * FROM tahfizh_data WHERE nis='$nis'";
$result = mysqli_query($koneksi, $query);
