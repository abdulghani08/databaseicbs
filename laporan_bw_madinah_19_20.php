...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('madinah 19', 'madinah 20') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('madinah 19', 'madinah 20')
...
<head>
    ...
    <title>Laporan BW - Asrama Madinah 19 & 20</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Madinah 19 & 20</h1>
