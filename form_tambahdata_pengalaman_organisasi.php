...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO pengalaman_organisasi_isi (nis, nama, asrama, kelas, nama_organisasi, jabatan, periode, tingkat) VALUES ('$nis', '$nama', '$asrama', '$kelas', '$nama_organisasi', '$jabatan', '$periode', '$tingkat')";
...
>>>>>>> a74c40d8e2cfd4f937b47d5c5f55958d68767b2c
    ...
    <div class="container py-2">
        <h2 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Form Tambah Pengalaman Organisasi</h2>
    </div>
    ...
    <div class="container mb-6">
        ...
        <a class="fw-bold py-2" style="font-size: 13px;" href="update_minatbakat.php?nis=<?php echo $nis; ?>&nama=<?php echo $nama; ?>">Kembali ke Data Santri</a>
                        ...
                        <div class=" justify-space-between table-responsive">
                            <form method="POST">
                                <div class="row">
                                    ...
                                    <label class="col-form-label2" for="nama_organisasi">Nama Organisasi</label>
                                    <input class="input-group2" type="text" id="nama_organisasi" name="nama_organisasi" required>
                                    </div>

                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="jabatan">Jabatan</label>
                                    <input class="input-group2" type="text" id="jabatan" name="jabatan"required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="periode">Periode</label>
                                    <input class="input-group2" type="text" id="periode" name="periode" required>
                                    </div>

                                    <div class="form-group col-12 col-md-6">
                                    <label class="col-form-label2" for="tingkat">Tingkat</label>
                                    <input class="input-group2" type="text" id="tingkat" name="tingkat"required>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <button type="submit" class="btn bg-gradient-info w-100" >Tambah</button>
                                </div>
                            </form>
                        </div>
                    </div>
