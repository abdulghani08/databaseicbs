...
<body>
    <div class="container">
        <a href="dt_kesehatan.php" class="back-link"><img src="../back_icon.png" alt="back"></a>
        
        <div class="details">
        <h2>REKAPAN KESEHATAN</h2>
        <div class="add-button">
            <a href="form_tambahdata_kesehatan.php?nis=<?php echo $nis; ?>&nama=<?php echo $nama; ?>">
                <i class="fas fa-plus-circle"></i> Tambah Diagnosa
            </a>
        </div>
            <table>
                <tr>
