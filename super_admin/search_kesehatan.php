...
<head>
    ...
    <title>Data Kesehatan Santri</title>
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td><?php echo $row['asrama']; ?></td>
                         ...
                         <a class="update" href="update_kesehatan.php?nis=<?php echo $row['nis']; ?>&nama=<?php echo $row['nama']; ?>">
