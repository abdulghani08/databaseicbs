...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('iskandariyah 3') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('iskandariyah 3')
...
<head>
    ...
    <title>Laporan BW - Asrama Iskandariyah 3</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Iskandariyah 3</h1>
