...
<body>
  ...
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/logo.png" alt="gambar 1" style="width:100%; height: 500px">
      </div>
      <div class="item">
        <img src="images/sekolah.jpg" alt="gambar 2" style="width:100%; height: 500px">
      </div>
      <!-- <div class="item">
      ...
      <div class="row margin-atas">
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>PBA (Pembinaan Baca Al-Quran)</h3>
        ...
        <div class="col-sm-6 col-md-3">
          <div class="thumbnail">
            ...
            <div class="caption">
              <h3>Mabit (Malam Bina Iman dan Taqwa) </h3>
            </div>
          </div>
        </div>
        <div class="col-sm-6 col-md-3">
  ...
  <div class="w3layouts_copy_right">
    <div class="container">
      ...
      <p>© 2023 MTsN Sunan Bonang | Design by <a href="http://instagram.com/abdulghani08">Abdul Ghani.</a></p>
    </div>
  </div>
  <!-- //footer -->
