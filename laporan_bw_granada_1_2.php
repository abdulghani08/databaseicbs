...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('granada 1', 'granada 2') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('granada 1', 'granada 2')
...
<head>
    ...
    <title>Laporan BW - Asrama Granada 1 & 2</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Granada 1 & 2</h1>
