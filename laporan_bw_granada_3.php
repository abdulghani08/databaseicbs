...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('granada 3') ORDER BY tanggal DESC, asrama ASC";
...
<head>
    ...
    <title>Laporan BW - Asrama Granada 3</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Granada 3</h1>
