...
<body style="overflow-x: hidden; background-image: url('backgroundgedung.jpg');">
    ...
    <div class="container py-2">
        <h1 class="text-center text-dark" style="font-family: 'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif;">Kelola Akun</h1>
    </div>
    
    <style>
        .button-container {
            display: grid;
            grid-template-columns: repeat(3, 1fr); /* Mengatur  jumlah tombol per baris */
        ...
        @media (max-width: 767px) {
            .button-container {
                display: flex;
                flex-direction: column; /* Menampilkan tombol dalam satu kolom pada layar kecil */
            }
        }
    </style>
    ...
    <div class="container">
        <div class="card shadow-lg p-3 mb-2 bg-body-tertiary rounded">
            <div class="button-container">
                <button class="rounded btn btn-kuning" onclick="location.href='form_register.php'">Tambahkan User</button>
                <button class="rounded btn btn-kuning" onclick="location.href='lihat_user.php'">Lihat Seluruh User</button>
                <button class="rounded btn btn-kuning" onclick="location.href='ganti_passwordadmin.php'">Ganti Password</button>
            </div>
        </div>
    </div>
