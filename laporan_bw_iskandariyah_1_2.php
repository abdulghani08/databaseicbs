...
$query = "SELECT * FROM tamu_laporan_bw WHERE asrama IN ('iskandariyah 1', 'iskandariyah 2') ORDER BY tanggal DESC, asrama ASC";
...
WHERE asrama IN ('iskandariyah 1', 'iskandariyah 2')
...
<head>
    ...
    <title>Laporan BW - Asrama Iskandariyah 1 & 2</title>
...
<body>
    <div class="container">
        ...
        <h1>Laporan BW - Asrama Iskandariyah 1 & 2</h1>
